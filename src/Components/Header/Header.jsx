            ...
            <div className=' h-[500px] lg:h-[600px] bg-[#FFCD29] overflow-hidden'>
                ...
                <div className='ps-10'>
                    ...
                    <div className='flex space-x-6 mt-16'>
                        <button className='bg-[#450475] flex items-center text-white px-3 py-1 rounded-lg'><IoLogoApple className=' text-3xl me-2' /> <p><p className='text-left '>Download on the <span className='inline sm:block text-left'>App store</span></p></p></button>

                        <button className='bg-[#450475] flex items-center text-white px-3 py-1 rounded-lg'><FaGooglePlay className=' text-3xl me-2' /> <p><p className='text-left '>Download on the <span  className='inline sm:block text-left'>Play store</span></p></p></button>
